 ...
 * @link      http://tomslabs.github.com/pear/
 */
abstract class AbstractBestOfMediaSniffUnitTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function runTest()
    {
        ...
        if ($standardName !== 'BestOfMedia' && is_file(dirname(__FILE__).'/../../CodeSniffer.php') === true) {
